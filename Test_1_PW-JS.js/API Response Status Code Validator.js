...
// Write a JavaScript program using a switch statement that takes an HTTP status code stored 
// in a variable and prints the category and a QA-friendly message.
